...
export const emailTemplates: Record<string, (...args: any[]) => string> = {
  welcomePatientClient: (firstName: string, username: string, password: string) => `
  ...
  welcomePatientAdmin: (firstName: string, lastName: string, email: string, username: string) => `
