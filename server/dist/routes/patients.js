...
exports.patientsRouter.get('/:id', auth_js_1.authenticateToken, (0, permissions_js_1.requirePermission)('patients'), async (req, res) => {
    try {
...
exports.patientsRouter.put('/:id', auth_js_1.authenticateToken, (0, permissions_js_1.requirePermission)('patients', 'write'), async (req, res) => {
    ...
    try {
        await (0, pool_js_1.query)('UPDATE patients SET first_name=$1, last_name=$2, date_of_birth=$3, gender=$4, blood_type=$5, phone=$6, email=$7, address=$8, emergency_contact=$9, allergies=$10, medical_history=$11 WHERE id=$12', [first_name, last_name, date_of_birth, gender, blood_type, phone, email, address, emergency_contact, allergies, medical_history, req.params.id]);
...
exports.patientsRouter.post('/:id/consultations', auth_js_1.authenticateToken, (0, permissions_js_1.requirePermission)('consultations', 'write'), async (req, res) => {
    ...
    try {
        await (0, pool_js_1.query)('INSERT INTO consultations (id, patient_id, date, motif, examen, diagnostic, traitement, note, author) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)', [id, req.params.id, date || new Date().toISOString().split('T')[0], motif, examen, diagnostic, traitement, note, "Dr. Moreau"]);
