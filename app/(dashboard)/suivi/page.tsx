...
export default function SuiviPage() {
  ...
  const exportCSV = () => {
    ...
    const headers = ["Date", "Systolic", "Diastolic", "Heart Rate", "SpO2", "Weight"];
    ...
    link.setAttribute("download", `suivi_patient_${patientId}.csv`);
        ...
        <CardContent className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              <YAxis />
              <Tooltip />
              <Line type="monotone" dataKey="systolic" stroke="var(--primary-red)" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
              <Line type="monotone" dataKey="diastolic" stroke="var(--warning)" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
