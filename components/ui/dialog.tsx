...
>(({ className, children, title, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border bg-card p-4 shadow-xl",
        className
      )}
      {...props}
    >
      ...
      <DialogClose className="absolute right-3 top-3 rounded-md p-1 text-foreground/60 hover:text-foreground hover:bg-black/5">
        <X className="h-4 w-4" />
